...
public class UIAndSceneManagement : MonoBehaviour
{
    ...
    public GameObject LoseGameOverScreen;
    ...
    private void Start()
    {
        ...
        LoseGameOverScreen.SetActive(false);
    ...
    public void LeaderBoardScene(string LeaderBoardScene)
    {
    ...
    #region [Win GameOver Screen]

    #endregion

    #region [Lose GameOver Screen]

    private void GameOverState()//string LoseOver)
    {
        if (isPlayerDeadCheck.isPlayerDead == true)
        {
            ...
            //SceneManager.LoadScene(LoseOver);
            ...
            ChooseScreen.SetActive(false);
            WinGameOverScreen.SetActive(false);
            LoseGameOverScreen.SetActive(true);
